 ...
 */
package eu.serco.dhus.server.http.webapp.wps;
...
@Component
@WebApp(name = "api/wps")
public class WpsWebapp extends WebApplication
{
   
   @Override
   public void configure(String dest_folder) throws IOException
   {
      String configurationFolder = "eu/serco/dhus/server/http/webapp/wps";
